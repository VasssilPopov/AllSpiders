...
#            f = open(fileName, 'w').close()
    ...
    def parse_page(self, response):
        ...
        texts=response.xpath('//div[@id="textsize"]/p/text() | //div[@id="textsize"]/p/b/text() | //div[@id="textsize"]/div/div/text() | //div[@id="textsize"]/div[@class="article-text"]/p/text() | //div[@id="textsize"]/div/p/text() | //div[@id="textsize"]/p/span/text() | //div[@id="textsize"]/div/text() | //div[@id="textsize"]/p/span/span/text()').extract()
