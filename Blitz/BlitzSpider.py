...
class BlitzSpider(scrapy.Spider):
    ...
    def parse_details(self, response):
        ...
        texts= ' '.join(response.xpath('//div[@id="articleContent"]/strong/font/font/text()| //div[@id="articleContent"]/h3/text()| //div[@id="articleContent"]/article/p/text()| //div[@id="articleContent"]/article/p/strong/text()| //div[@id="articleContent"]/strong/text() | //div[@id="articleContent"]/text()| //div[@id="articleContent"]/p/strong/text()| //div[@id="articleContent"]/p/text() | //div[@id="articleContent"]/p/strong/font/font/text() | //div[@id="articleContent"]/div/strong/text() | //div[@id="articleContent"]/div/text()').extract())
