...
class TrudSpider(scrapy.Spider):
	...
	def parse_details(self, response):
		...
		article = u' '.join(response.xpath('//div[@class="article-content"]/p/text() | //div[@class="article-content"]/div/div/text() | //div[@id="AppleMailSignature"]/text() | //div[@class="article-content"]/p/span/text()  | //div[@class="article-content"]/p/b/text()  | //div[@class="article-content"]/p/text()  | //div[@class="article-content"]/p/span/span/text() | //div[@class="article-content"]/p/span/span/b/text()').extract())
