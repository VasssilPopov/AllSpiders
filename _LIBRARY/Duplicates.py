...
#displayDuplicates ('24chasa/Reports/24chasa-2019-07-*.json')


def reportDuplicates (path):
        # init variables
        print ">> Duplicates Report:" + path
        #print ">> for ["+str(path)+"]"
...
#reportDuplicates ('C:\Study_Spiders\_AllSpiders\PIK/Reports/PIK-2019-07-10.json')
