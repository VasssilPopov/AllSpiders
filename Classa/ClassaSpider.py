...
class ClassaSpider(scrapy.Spider):
    ...
    def parse_details(self, response):
        ...
        texts=response.xpath('//div[@id="k2Container"]/div/div/p/strong/span/text() | //div[@class="itemFullText"]/p/span/strong/text() | //div[@class="itemFullText"]/p/strong/span/text() | //div[@class="itemFullText"]/p/span/text() | //div[@class="itemFullText"]/div/span/text() | //div[@class="itemFullText"]/div/span/em/span/a/text() | //div[@class="itemFullText"]/h2/text() | //div[@class="itemFullText"]/p/text() | //div[@class="itemFullText"]/div[@class="article-body"]/p/span/text() | //div[@class="itemIntroText"]/p/span/text() | //div[@class="itemIntroText"]/p/span/strong/span/text() | //div[@class="itemFullText"]/div/p/span/text() | //div[@class="itemFullText"]/div/p/em/span/strong/text() | //div[@class="itemFullText"]/p/span/span/text() | //div[@class="itemFullText"]/div/ul/li/text() | //div[@id="k2Container"]/div/div/div/div/ul/li/strong/text() | //div[@id="k2Container"]/div/div/div/div/ul/li/text()  | //div[@id="k2Container"]/div/div/div/div/ul/li/a/text()').extract()
