...
# # File to check
# json_datafile = 'Reports/BulgariaUtre-'+Yesterday+'.json'
...
json_datafile = 'BulgariaUtre/Reports/BulgariaUtre-'+Yesterday+'.json'
...
if os.path.isfile(json_datafile):
	...
	#checkReport('BulgariaUtre/Reports/BulgariaUtre-2017-07-18.json')------------
